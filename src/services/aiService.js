...
Также верни блок "compatibilityNotes" — это краткое текстовое описание, можно ли принимать некоторые добавки вместе (если они принимаются в одно время). Пример:
